...
class Trainer(object):
    ...
    def get_loss(self, net_output, 
                 patch_masks, bgcolor, targets, div_indices ,iter=10000):
    ...
    def progress(self):
        ...
        os.makedirs(os.path.join(cfg.logdir,str(cfg.now_subject)),exist_ok=True)
        Image.fromarray(tiled_image).save(
            os.path.join(cfg.logdir, str(cfg.now_subject),"prog_{:06}.jpg".format(self.iter)))
